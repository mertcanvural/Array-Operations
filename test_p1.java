class test_p1 {
	public static void main(String[] args) {
		...
		if (args.length != 6) {
			System.out.println(
					"format test_p1 \"filename\" \"lower bound\" \"upper bound\" \"test value\" \"test value 1\" \"test value 2\"");
			System.exit(0);
		}
		...
		try {
			...
			vural_p1 testClass = new vural_p1();
			...
			int doWhileLoopTestResult = testClass.doWhileLoopTest(lowerBound, upperBound, testValue1, testValue2,
					testValues);
			System.out.println("doWhileLoopTestResult = " + doWhileLoopTestResult);

			// call the do while loop test a second time, with testvalue1 and testValue2
			// swapped,
			// and output the results
			int doWhileLoopTestResult2 = testClass.doWhileLoopTest(lowerBound, upperBound, testValue2, testValue1,
					testValues);
